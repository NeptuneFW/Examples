                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" name="article_content" class="tiny form-control" placeholder=" {{ \Libs\Languages::temporarilySet(['tr_TR' => 'Buraya makale içeriği gelecek', 'en_US' => 'Article content here']) }}">
                                @if(isset($edit)) {{ $description }} @endif
                            </textarea>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="post_category" class="form-control">
                                @foreach ($categories_for_post as $category)
