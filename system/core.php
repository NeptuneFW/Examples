...
trait Core {
    ...
    public function __construct()
    {
        ...
        if(!Cookie::issetCookie('color1'))
        {
            $color1 = 'grey';
            Cookie::set('color1', 'grey', true, time()+60*60*24*30*12*10);
            $color2 = 'orange';
            Cookie::set('color2', 'orange', true, time()+60*60*24*30*12*10);
        }
        else
        {
            $color1 = Cookie::get('color1');
            $color2 = Cookie::get('color2');
        }
        ...
        $this->assets->createAssetsGroup("main")
            ...
            ->createAsset("materialColorPalette", "css", "https://code.getmdl.io/1.3.0/material.". $color1 ."-" . $color2  . ".min.css", "materialColorPalette")
